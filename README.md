...
A collection of standalone scripts that I have created, adapted, or refined over time and found useful, interesting, or fun enough to share.

## Script Catalog

| Script | Purpose |
| --- | --- |
| [`Dont-Hit-Stuff.ps1`](./Dont-Hit-Stuff.ps1) | A tiny humorous PowerShell script that randomly decides whether it is "going to hit stuff" and, when the condition is met, executes the appropriate response: `Dont`. |
